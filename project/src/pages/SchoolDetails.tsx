...
import { Download, FileText, Star, TrendingUp, TrendingDown, AlertCircle, BarChart3, PieChart, School, Calendar } from 'lucide-react';

const SchoolDetails: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  
  // Mock data for the school details
  const school = {
    id,
